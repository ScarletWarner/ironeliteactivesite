<?php
  ...
  <?php
	...
	$email_subject = "Coaching Inquiry Submission";

	$email_body = "You have received a new coaching inquiry:
            Name: $name
			Email: $visitor_email 
			Goals: $message
...
<?php							
  ...
  $to = "scarlet@ironelitetraining.com, roman@ironelitetraining.com";
